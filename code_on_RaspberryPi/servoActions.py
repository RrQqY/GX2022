...
class servoActions():
    ...
    def Servo_prepare_1(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.prepare_1[0][3],velocity=200.0, t_acc=50, t_dec=100)
    ...
    def Get_pla1_pos1_up(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla1_pos1_up_get[0][3],velocity=200.0, t_acc=50, t_dec=100)
    ...
    def Get_pla1_pos2_up(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla1_pos2_up_get[0][3],velocity=200.0, t_acc=50, t_dec=100)
    ...
    def Get_pla1_pos1_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla1_pos1_down_get[0][0],velocity=115.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla1_pos1_down_get[0][1],velocity=100.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla1_pos1_down_get[0][2],velocity=50.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla1_pos1_down_get[0][3],velocity=140.0, t_acc=10, t_dec=100)
    ...
    def Get_pla1_pos2_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla1_pos2_down_get[0][0],velocity=115.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla1_pos2_down_get[0][1],velocity=100.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla1_pos2_down_get[0][2],velocity=50.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla1_pos2_down_get[0][3],velocity=140.0, t_acc=10, t_dec=100)
    ...
    def Get_pla1_pos3_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla1_pos3_down_get[0][0],velocity=115.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla1_pos3_down_get[0][1],velocity=100.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla1_pos3_down_get[0][2],velocity=50.0, t_acc=600, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla1_pos3_down_get[0][3],velocity=140.0, t_acc=10, t_dec=100)
    ...
    def Get_pla2_pos1(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla2_pos1_get[4][3],velocity=100.0, t_acc=100, t_dec=100)
    ...
    def Get_pla2_pos2(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla2_pos2_get[4][3],velocity=100.0, t_acc=100, t_dec=100)
    ...
    def Get_pla2_pos3(self):
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla2_pos3_get[4][3],velocity=100.0, t_acc=100, t_dec=100)
    ...
    pla3_pos1_down_put = [[57, -5, 82, -30, -115],       # 先把物块移出去
                          [57, -15, 135, 75, -110],       # 放到色环上方
                          [57, -65, 122, 94, -110],       # 放到色环上
                          [57, -65, 122, 94, -80],        # 松开
                          [57, -20, 125, 70, -80]]        # 缩回
    # 放置货架③（场地上方）下层位置1
    def Put_pla3_pos1_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos1_down_put[0][1],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla3_pos1_down_put[0][2],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla3_pos1_down_put[0][3],velocity=200.0, t_acc=50, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_5, servoActions.pla3_pos1_down_put[0][4],velocity=200.0, t_acc=100, t_dec=100)
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos1_down_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    def Put_pla3_pos2_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos2_down_put[0][1],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla3_pos2_down_put[0][2],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla3_pos2_down_put[0][3],velocity=200.0, t_acc=50, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_5, servoActions.pla3_pos2_down_put[0][4],velocity=200.0, t_acc=100, t_dec=100)
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos2_down_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    pla3_pos3_down_put = [[122, -5, 82, -30, -115],       # 先把物块移出去
                          [122, -15, 135, 75, -110],
                          [122, -66, 120, 94, -110],
                          [122, -66, 120, 94, -80],
                          [122, -20, 125, 70, -80]]
    ...
    def Put_pla3_pos3_down(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos3_down_put[0][1],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_2, servoActions.pla3_pos3_down_put[0][2],velocity=200.0, t_acc=100, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.pla3_pos3_down_put[0][3],velocity=200.0, t_acc=50, t_dec=100)
        self.uservo.set_servo_angle(self.SERVO_ID_5, servoActions.pla3_pos3_down_put[0][4],velocity=200.0, t_acc=100, t_dec=100)
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos3_down_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    pla3_pos1_up_put = [[57, 0, 82, -10, -115],        # 先把物块移出去
                        [57, -12, 95, 33, -110],       # 放到物块上方
                        [57, -38, 123, 65, -110],       # 放到物块上
                        [57, -38, 123, 65, -80],        # 松开
                        [57, 8, 105, -40, -80]]          # 缩回
    # 放置货架③（场地上方）上层位置1
    def Put_pla3_pos1_up(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos1_up_put[0][1],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos1_up_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(2.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos1_up_put[2][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(1)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos1_up_put[3][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.5)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos1_up_put[4][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    pla3_pos2_up_put = [[90, 0, 82, -10, -115],        # 先把物块移出去
                        [90, 0, 117, 43, -110],
                        [90, -22, 132, 51, -110],
                        [90, -22, 132, 51, -80],
                        [90, 8, 90, -60, -80]]
    ...
    def Put_pla3_pos2_up(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos2_up_put[0][1],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos2_up_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(2.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos2_up_put[2][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(1)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos2_up_put[3][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.5)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos2_up_put[4][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    pla3_pos3_up_put = [[122, 0, 82, -10, -115],        # 先把物块移出去
                        [122, -12, 95, 33, -110],
                        [122, -38, 123, 65, -110],
                        [122, -38, 123, 65, -80],
                        [122, 8, 105, -40, -80]]
    ...
    def Put_pla3_pos3_up(self):
        self.uservo.set_servo_angle(self.SERVO_ID_1, servoActions.pla3_pos3_up_put[0][1],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos3_up_put[1][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(2.7)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos3_up_put[2][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(1)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos3_up_put[3][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        # self.uservo.wait()
        time.sleep(0.5)
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.pla3_pos3_up_put[4][0],velocity=150.0, t_acc=100, t_dec=100)
    ...
    def Depo_left_out(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.depo_left_out[0][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_left_out[0][3],velocity=180.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_left_out[1][3],velocity=180.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_left_out[2][3],velocity=180.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_left_out[3][3],velocity=180.0, t_acc=100, t_dec=100)
    ...
    def Depo_middle_out(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.depo_middle_out[0][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_middle_out[0][3],velocity=180.0, t_acc=100, t_dec=100)
    ...
    def Depo_right_out(self):
        self.uservo.set_servo_angle(self.SERVO_ID_0, servoActions.depo_right_out[0][0],velocity=150.0, t_acc=100, t_dec=100)
        ...
        self.uservo.set_servo_angle(self.SERVO_ID_3, servoActions.depo_right_out[0][3],velocity=180.0, t_acc=100, t_dec=100)
